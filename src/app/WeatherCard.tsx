    ...
    return(
            <div className="w-full h-auto bg-primary rounded-xl shadow border p-0 m-0">
                <div className="flex flex-col flex-wrap items-center">
                    ...
                    <p className="text-2xl text-white">{Math.round((weatherData.currentTemp - 32) * 5/9)} {'\u00b0'}C</p>
                ...
                <div className="flex flex-row flex-wrap justify-center pt-14">
                    ...
                    <p className="text-xl text-white pl-5">{Math.round((weatherData.feelsLike - 32) * 5/9)} {'\u00b0'}C</p>
                </div >
